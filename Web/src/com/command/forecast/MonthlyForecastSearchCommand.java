...
import com.dao.MonthlyForecastDAO;
import com.dto.ForecastDTO;
import com.dto.MonthlyForecastDTO;

public class MonthlyForecastSearchCommand implements Command {
	...
	public ForwardingAction execute(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		ArrayList<MonthlyForecastDTO> forecastList = null;
		MonthlyForecastDAO dao = new MonthlyForecastDAO();
	...
	private String convertToJson(ArrayList<MonthlyForecastDTO> list) {
